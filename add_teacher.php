...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ( isset( $data ) ) {
        ...
        $sql = "INSERT INTO $table_name (id, added_at, added_by, email, name, pwd, subject, p1, p2, p3, p4, p5 , p6, p7, p8, p9, p10, p11, p12, p13, p14, p15, p16, p17, p18)
VALUES ('$id', '$added_at', '$added_by', '$email', '$name', '$pwd', '$subject', '$p1', '$p2', '$p3', '$p4', '$p5', '$p6', '$p7', '$p8', '$p9', '$p10', '$p11', '$p12', '$p13', '$p14', '$p15', '$p16', '$p17', '$p18')";
